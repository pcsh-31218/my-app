...
function App() {
  ...
  const handleExport = () => {
    const text = messages.map(m => `[${m.role === "interviewer" ? (interviewerName || "面試官") : (intervieweeName || "應試者")}  ${m.timestamp}]\n${m.content}`).join("\n\n");
    alert(text || "（尚無訊息）");
  };
    ...
    <div className="app-root">
      ...
      <div className="line-header">
        ...
        <div className="header-actions">
          <button className="header-icon" onClick={handleExport}>↑</button>
